...
public class Onboarding extends AppCompatActivity {
    ...
    ImageView backbtn_ellipse, nextbtn_ellipse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtn_ellipse = findViewById(R.id.ellipse1);
        nextbtn_ellipse = findViewById(R.id.ellipse2);
        backbtn_ellipse.setVisibility(View.INVISIBLE);
    ...
    public void setUpindicator(int position){
        ...
        for (int i = 0 ; i < dots.length ; i++){
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                dots[i].setTextColor(getResources().getColor(R.color.Outline,getApplicationContext().getTheme()));
            }
    ...
    ViewPager.OnPageChangeListener viewListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position > 0){
                backbtn_ellipse.setVisibility(View.VISIBLE);
