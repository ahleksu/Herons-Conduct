...
public class ReporterSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_reporter_settings, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // FOR NAME AND TYPE
        TextView txt_name_reporter = view.findViewById(R.id.txt_name_reporter);
        TextView txt_type_reporter = view.findViewById(R.id.txt_type_reporter);
                ...
                .get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            txt_type_reporter.setText(documentSnapshot.get("type").toString());
                        }
                    }
        ...
        firestore.collection("reporter").document(firebaseAuth.getUid())
                .get()
